		...
		<view class="content main ">
			<view class="p-t-40">
				...
				<view class="flex_sp_ar m-b-40 p-t-40">
					...
					<izUploaderImg style="width: 100%;" :number="1" :configObj="configObj" :isUploadUrl="isUploadUrl0"
						@delImagefun="delImagefun0" @successImg="successImg0" @kaishi="kaishi0" @qingkong="qingkong0">
					</izUploaderImg>
				</view>
			</view>
			<view class="p-t-40">
				...
				<view class="flex_sp_ar m-b-40 p-t-40">
					...
					<izUploaderImg style="width: 100%;" :number="1" :configObj="configObj" :isUploadUrl="isUploadUrl1"
						@delImagefun="delImagefun1" @successImg="successImg1" @kaishi="kaishi1" @qingkong="qingkong1">
					</izUploaderImg>
				</view>
			</view>
			<view class="p-t-40 p-b-40">
				...
				<view class="flex_sp_ar m-b-40 p-t-40">
					...
					<izUploaderImg style="width: 100%;" :number="1" :configObj="configObj" :isUploadUrl="isUploadUrl2"
						@delImagefun="delImagefun2" @successImg="successImg2" @kaishi="kaishi2" @qingkong="qingkong2">
					</izUploaderImg>
				</view>
			</view>
			<button class="button footFixedButton" @click="submit('valiForm')">{{$t('confirm')}}</button>
		</view>
	</view>
</template>
